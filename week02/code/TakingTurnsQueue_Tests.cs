...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Queue was working like a stack, so the order of the people was reversed.I modified the Dequeue method to remove the last item in the list instead of the first item.
    ...
    // Defect(s) Found: No Defect Found (worked fine after fixing for test 1)
    ...
    // Defect(s) Found: Did not return any output. I updated the Get next Person by checking if the Turns were less than 1. and simple enqueing that person without reducing the turns
